  ...
  <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
      ...
      <body>
        ...
        <div class="quick-wrap" role="tablist">
          <span class="sr-only">바로가기</span>
          <a href="#section01" role="tab" aria-controls="tabpanel01">기본정보</a>
          <a href="#section02" role="tab" aria-controls="tabpanel02">이력</a>
          <a href="#section03" role="tab" aria-controls="tabpanel03">프로젝트 수행</a>
          <a href="#section04" role="tab" aria-controls="tabpanel04">자격/면허</a>
          <a href="#section05" role="tab" aria-controls="tabpanel05">보유기술 및 능력</a>
          <a href="#section06" role="tab" aria-controls="tabpanel06">교육이수내역</a>
          <a href="#section07" role="tab" aria-controls="tabpanel07">학력</a>
        </div>
        <section class="content">
          <h2 class="title" id="section01">기본정보</h2>
          <div class="section" id="tabpanel01" role="tabpanel">
          ...
          <div id="tabpanel02" role="tabpanel">
          ...
          <div id="tabpanel03" role="tabpanel">
            <table class="rwd-table">
          ...
          <div id="tabpanel04" role="tabpanel">
            <table class="rwd-table">
          ...
          <div id="tabpanel05" role="tabpanel">
            <table class="rwd-table">
          ...
          <div id="tabpanel06" role="tabpanel">
            <table class="rwd-table">
          ...
          <div id="tabpanel07" role="tabpanel">
