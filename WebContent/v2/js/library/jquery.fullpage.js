    ...
    $.fn.fullpage = function(options) {
        ...
        */
        function prepareDom(){
            ...
            container.parents('.main-wrap').attr('aria-live', 'polite');
        ...
        */
        function styleSection(section, index){
            ...
            section.attr('role', 'option');
            section.attr('aria-hidden', true);
            
            if (typeof options.anchors[index] !== 'undefined') {
                section.attr('data-anchor', options.anchors[index]);
                section.attr('id', options.anchors[index]);
                section.attr('aria-describedby', options.anchors[index]+'Tab');
            }
        ...
        */
        function addVerticalNavigation(){
            $('.main-wrap').prepend('<div id="' + SECTION_NAV + '"><ul role="tablist"></ul></div>');
            ...
            for (var i = 0; i < $(SECTION_SEL).length; i++) {
                ...
                var li = '<li role="presentation"><a href="#' + link + '" id="'+link+'Tab" role="tab" aria-selected="'+aria_selected+'" aria-controls="'+link+'" ><span></span>';
        ...
        */
        function afterRenderActions(){
            ...
            section.find('a, button, [aria-hidden="false"][tabindex=-1]').attr('tabindex', 0);
            section.siblings().find('a, button, [tabindex=0]').attr('tabindex', -1);
            ...
            if(!options.autoScrolling || options.scrollBar){
                ...
                if(!currentSection.hasClass(ACTIVE)){
                    ...
                    if(canScroll){
                        ...
                        currentSection.attr('aria-selected', true).siblings().attr('aria-selected', false);
        ...
        */
        ...
        function scrollPage(element, callback, isMovementUp){
            ...
            element.find('a, button').attr('tabindex', 0);
            element.siblings().find('a, button, [tabindex=0]').attr('tabindex', -1);
            lazyLoad(element);
        ...
        */
        function afterSectionLoads (v){
            ...
            v.element.find('a, button, [aria-hidden="false"][tabindex=-1]').attr('tabindex', 0);
            v.element.siblings().find('a, button, [tabindex=0]').attr('tabindex', -1);
            v.element.attr('aria-hidden', false).siblings().attr('aria-hidden', true);
        ...
        */
        function lazyLoad(destiny){
            ...
            panel.find('img[data-src], img[data-srcset], source[data-src], source[data-srcset], video[data-src], audio[data-src], iframe[data-src]').each(function(){
                ...
                if(element.is('source') && !element.closest('picture')){
        ...
        */
        function activateNavDots(name, sectionIndex){
            if(options.navigation){
                $(SECTION_NAV_SEL).find(ACTIVE_SEL).removeClass(ACTIVE).attr('aria-selected', false);
                if(name){
                    $(SECTION_NAV_SEL).find('a[href="#' + name + '"]').addClass(ACTIVE).attr('aria-selected', true);
                }else{
                    $(SECTION_NAV_SEL).find('li').eq(sectionIndex).find('a').addClass(ACTIVE).attr('aria-selected', true);
                }
            }
        }
